...
<div class="items-center px-5 align-middle sm:px-20 lg:px-40">
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            This section will give a walkthrough of each object, their properties, and how to build 
            a full event to be exported to OBS.
        </span>
    </div>
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            The DJs page can be accessed by the navigation bar at the top of the page. New entries can 
            be added by clicking on the "New DJ" button in the top right. Existing entries can be 
            edited by clicking on their name, or the ellipses dropdown in their row.
    ...
    <div class="flex flex-col">
        ...
        <span class="flex flex-row my-2">
            Both the `Logo File` and `Recording File` point to a `File` object, which can be accessed/set by clicking on their buttons.
        </span>
        <span class="flex flex-row my-2">
            ...
            `FILE_SERVER_AUTHORIZATION` when accessing. When picking a local file, a preview will be displayed 
            if the browser can render it (Firefox by default lacks a lot of compatibility).
        </span>
    </div>
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            Events can be created by accessing the Events page, same editing as DJs and Promotions. 
            As your events increase, make sure to use the sorting and searching options to save time 
            finding the event you want to edit. The following are values you can set for an Event:
        </span>
    </div>
    <h1 class="scroll-m-20 py-2 text-center text-3xl font-bold tracking-tight lg:text-2xl">
		Event DJs
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            Each event will have a list of DJs, they can be added by clicking the **+** button next the `DJs`. 
            In this window you can either select multiple entries from existing DJ entries. Make sure to clear 
            your selection before clicking "Select". After adding DJs, their order can be changed by 
            dragging and dropping their table row. Each Event DJ has the following properties:
        </span>
    </div>
    <Table.Root>
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            Clicking on the ellipses for a DJ's row will give the option to toggle being live, or edit the VJ. 
            There is an edit option, which will open the DJ's page in a new tab. The remove button will remove 
            the DJ from the event, but not delete the DJ.
        </span>
    </div>
    <h1 class="scroll-m-20 py-2 text-center text-3xl font-bold tracking-tight lg:text-2xl">
		Event Promotions
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            Similar to Event DJs, but with no editable values.
        </span>
    </div>
    <h1 class="scroll-m-20 py-2 text-center text-3xl font-bold tracking-tight lg:text-2xl">
		Event Date and Time
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            Clicking on the calendar button will let you select the date of the event.
            Adjusting the values after "Staring Time" will set the start time, in US eastern time.
        </span>
    </div>
    <h1 class="scroll-m-20 py-2 text-center text-3xl font-bold tracking-tight lg:text-2xl">
		Event Theme
    ...
    <div class="flex flex-col">
        <span class="flex flex-row my-2">
            ...
            This will show a summary of each DJ with their displayed content, and a similar table for promotions. 
            A preview of the choosen theme's dimensions and assets will be shown as well.
            Any obvious errors will be pointed out here, but the user can still try to export the event. 
            If the export succeded, a message telling you the file has been saved should be shown, you are now
            set to import this file into OBS and the event should be nearly good to go!
        </span>
    </div>
</div>
